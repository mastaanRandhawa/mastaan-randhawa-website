    ...
    <section className="min-h-screen flex items-center pt-16 bg-white dark:bg-zinc-950">
      <div className="max-w-6xl mx-auto px-6 py-24 w-full">
        <div className="max-w-3xl">
          {/* Label */}
          <div className="inline-flex items-center gap-2 font-mono text-xs text-zinc-500 dark:text-zinc-400 mb-8 border border-zinc-200 dark:border-zinc-800 rounded-full px-4 py-1.5">
            <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
            Available for opportunities
          </div>

          {/* Heading */}
          <h1 className="font-serif italic text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-zinc-900 dark:text-white leading-none mb-6">
            Hi, I'm{" "}
          ...
          <div className="h-8 mb-6">
            <p className="font-mono text-sm sm:text-base text-zinc-500 dark:text-zinc-400">
              {typewriterText}
          ...
          {/* Description */}
          <p className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed mb-10 max-w-xl">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            <a
              href="#portfolio"
              className="inline-flex items-center gap-2 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-mono text-sm px-6 py-3 rounded-full hover:bg-accent-blue dark:hover:bg-accent-blue dark:hover:text-white transition-all duration-200 group"
            >
              View My Work
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="GitHub"
              className="w-10 h-10 flex items-center justify-center rounded-full border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:border-accent-blue hover:text-accent-blue dark:hover:border-accent-blue dark:hover:text-accent-blue transition-all duration-200"
            >
              <Github size={18} />
            </a>
            <a
